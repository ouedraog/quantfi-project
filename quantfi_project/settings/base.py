...
ROOT_URLCONF = 'quantfi_project.urls'
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'quantfi_project.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'quantfi_project.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[quantfi_project]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_quantfi_project"  # Make this unique to your project.
